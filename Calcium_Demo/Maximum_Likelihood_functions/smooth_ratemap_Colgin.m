function smRateMap = smooth_ratemap_Colgin(rateMap)
% Available from: Colgin Lab
% https://github.com/jtrimper/ColginLabCode/tree/master/GENERAL_LAB_CODE 

% function smRateMap = smooth_ratemap(rateMap)
%
% PURPOSE: 
%   To apply Gaussian smoothing box to the rate maps
%
% INPUT: 
